 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t fdp/food-delivery-app-fe:${VERSION} .'
          sh 'docker push fdp/food-delivery-app-fe:${VERSION}'
      }
    }
     ...
     stage('Update Image Tag in GitOps') {
      steps {
       ...
       sh '''
          sed -i "s/image:.*/image: fdp\\/food-delivery-app-fe:${VERSION}/" aws/angular-manifest.yml
        '''
